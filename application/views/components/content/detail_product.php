        ...
        <div class="card-body">
            <div class="row">
                <div class="col-md-6 mb-4 d-flex justify-content-center align-items-center" style="width:400px;">
                    <img src="<?= base_url('public/image/uploads/products/' . $matched_product['product_image']) ?>" class="img-fluid rounded object-fit-cover h-100" alt="Product Image">                    
                </div>
                    ...
                    <form action="<?= base_url('C_checkout/add_to_cart/') ?>" method="post">
                        ...
                        <div class="mb-4">
                            ...
                            <div class="input-group" style="width: 150px;">
                                ...
                                <input type="number" id="numberInput" name="quantity" class="form-control text-center" value="1" min="1" max="<?= $matched_product['product_stock'] ?>" oninput="updatePrice(<?= $matched_product['product_price'] ?>)">
